import{r as w,j as a}from"./iframe-C90DYGFN.js";import{P as y,a as D,b as u,c as _,e as C,d as R,f as b}from"./pagination-uQ53c6WC.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-BQHNewu7.js";import"./button-COc3hSJE.js";import"./index-BlYFGBPj.js";import"./index-LHNt3CwB.js";import"./createLucideIcon-BZnvhNpQ.js";const l=(t,n)=>{const s=n-t+1;return Array.from({length:s},(r,p)=>p+t)},S=({pagination:t,page:n,setPage:s,siblingCount:r=1})=>{const p=w.useMemo(()=>{if(!t)return[];const e=t.totalPages,m=r*2+5;if(e<=m)return l(1,e);const h=Math.max(n-r,1),f=Math.min(n+r,e),d=h>2,P=f<e-1,x=1,v=e,M=3+r*2;if(d&&!P){const j=Math.max(e-M+1,1);return[x,"Dot",...l(j,e)]}return!d&&P?[...l(1,M),"Dot",v]:d&&P?[x,"Dot",...l(h,f),"Dot",v]:[]},[n,t,r]);return a.jsx(y,{className:"text-foreground mt-2",children:a.jsxs(D,{children:[a.jsx(u,{children:a.jsx(_,{className:t?.hasPrevious?"cursor-pointer":"cursor-not-allowed",onClick:()=>{t?.hasPrevious&&s(e=>e-1)},children:"Previous"})}),p?.map((e,m)=>e==="Dot"?a.jsx(u,{children:a.jsx(C,{})},`ellipsis-${m}`):a.jsx(u,{children:a.jsx(R,{isActive:n===e,onClick:()=>{s(e)},children:e})},e)),a.jsx(u,{children:a.jsx(b,{className:t?.hasMore?"cursor-pointer":"cursor-not-allowed",onClick:()=>{t?.hasMore&&s(e=>e+1)},children:"Next"})})]})})};S.__docgenInfo={description:`Custom pagination component used for the specific pagination object received from api\r
